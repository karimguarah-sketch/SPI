        ...
        <section className="mb-8 max-w-3xl">
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-base font-bold text-[#007F8C]">Bulk edition</p>
              ...
              <div className="flex gap-6">
                <button
                  ...
                  className={`pb-3 text-sm font-semibold transition-colors relative ${
                    activeTab === 'future' ? 'text-[#007F8C]' : 'text-gray-500'
                  }`}
                >
                  Future changes
                  {activeTab === 'future' && (
                ...
                <button
                  ...
                  className={`pb-3 text-sm font-semibold transition-colors relative ${
                    activeTab === 'past' ? 'text-[#007F8C]' : 'text-gray-500'
                  }`}
                >
                  Past changes
                  {activeTab === 'past' && (
    ...
    <div className="border-b border-gray-200 last:border-b-0 px-6 py-5">
      ...
      {item.referencesPreview ? (
        <div className="flex items-center gap-3">
          <div className="flex-1 bg-[#D9F0F3] rounded-md px-4 py-3 flex items-center gap-3 min-w-0">
        ...
        <div className="grid grid-cols-[auto_1fr_auto_auto] gap-3 items-stretch">
          <div className="bg-[#D9F0F3] rounded-md px-4 py-3 flex items-center gap-2">
          ...
          {item.supplier && (
            <div className="bg-[#D9F0F3] rounded-md px-4 py-3 flex items-center gap-2 min-w-0">
              <svg className="w-4 h-4 text-gray-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
              <span className="text-sm text-gray-800 truncate">{item.supplier}</span>
              {item.supplierZone && (
                <span className="text-[11px] font-medium text-[#007F8C] border border-[#007F8C] rounded px-1.5 py-0.5 shrink-0">
                  {item.supplierZone}
                </span>
              )}
            </div>
